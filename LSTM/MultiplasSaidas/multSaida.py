...
def preProcessingTestBase ( dfTreinamento, normalizador ) :
    ...
    dfTeste = pd.read_csv ( "/home/borin/Documents/AtomProgramas/AcaoPetrobras/petr4-teste.csv" )
...
def preProcessingTrainDatabase (  ) :
    ...
    df = pd.read_csv ( "/home/borin/Documents/AtomProgramas/AcaoPetrobras/petr4-treinamento.csv" )
    df = df.dropna()
